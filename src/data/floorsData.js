    ...
    rooms: [
      {
        ...
        description:
          "A room used by instructional and research faculty in an office (i.e., working at a desk or table).",
      },
      {
  ...
  },
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        description:
          "A room located in areas, not assigned to libraries, that individuals use to study at their convenience.",
      },
      {
        name: "420 - Collections",
        description:
          "A room or portion of a room in a campus library used to provide shelving for library or audio-visual materials.",
      },
      {
